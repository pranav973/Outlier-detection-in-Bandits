...
Original file is located at
    https://colab.research.google.com/drive/1ZsGPcer8MkxkyTX02Fv6ANaPV4tt1KTo
"""
...
for r in range(10):
  ...
  while bound_set:
    ...
    sorted_means = sort([(estimates[p],p) for p in range(n)],key = fun)
    median_est = sorted_means[n//2]
    AD = np.absolute(estimates-median_est)
    set_1 = set()
    set_2 = set()
    set_3 = set()
    L_m1 = min()
